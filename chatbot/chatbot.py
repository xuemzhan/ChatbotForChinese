...
class Chatbot:
    ...
    def parseArgs(args):
        ...
        nnArgs.add_argument('--hiddenSize', type=int, default=512, help='number of hidden units in each RNN cell')#512
        ...
        trainingArgs.add_argument('--numEpochs', type=int, default=70, help='maximum number of epochs to run')
